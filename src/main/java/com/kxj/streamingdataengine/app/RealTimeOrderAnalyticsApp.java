...
public class RealTimeOrderAnalyticsApp {
    ...
    static class OrderSumAggregate 
        implements com.kxj.streamingdataengine.aggregation.AggregateFunction<Order, OrderSumResult> {
        ...
        @Override
        public void accumulate(Order value) {
            if (userId == null) {
        ...
        @Override
        public OrderSumResult getResult() {
        ...
        @Override
        public void merge(com.kxj.streamingdataengine.aggregation.AggregateFunction<Order, OrderSumResult> other) {
            if (other instanceof OrderSumAggregate) {
                OrderSumAggregate o = (OrderSumAggregate) other;
                this.count += o.count;
                this.sum += o.sum;
            }
        }
