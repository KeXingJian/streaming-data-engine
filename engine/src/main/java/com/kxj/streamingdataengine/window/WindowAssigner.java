...
public class WindowAssigner {
    ...
    /**
         * 滚动时间窗口分配器
         */
        private record TumblingTimeWindowAssigner<T>(long size) implements Window.Assigner<T> {
    ...
    /**
         * 滑动时间窗口分配器
         */
        private record SlidingTimeWindowAssigner<T>(long size, long slide) implements Window.Assigner<T> {
    ...
    /**
         * 会话窗口分配器
         */
        private record SessionWindowAssigner<T>(long gap) implements Window.Assigner<T> {
    ...
    /**
         * 计数窗口分配器
         */
        private record CountWindowAssigner<T>(long size, long slide) implements Window.Assigner<T> {
